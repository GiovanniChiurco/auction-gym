...
def run_simulation(budget, alpha, soglia_num_pub, output_dir, init_publisher_list, embedding_size, user_contexts, sigmoids, publisher_embeddings, auction, num_iter, rounds_per_iter):
    print(f'Running simulation with budget={budget}, alpha={alpha} and max num of publishers={soglia_num_pub}')
    budget_results = simulation_run(budget, alpha, init_publisher_list, user_contexts, sigmoids, publisher_embeddings, auction, num_iter, rounds_per_iter, soglia_num_publisher=soglia_num_pub, embedding_size=embedding_size)
...
if __name__ == "__main__":
    ...
    # tasks = [(budget, alpha, soglia_num_pub, output_dir, init_publisher_list, embedding_size, user_contexts, sigmoids, publisher_embeddings, auction, num_iter, rounds_per_iter)
